        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            ...
            <input
              ...
              className="w-full rounded-xl border border-slate-300 px-4 py-3.5 text-base focus:border-brand-500 focus:ring-2 focus:ring-brand-500 outline-none"
              required
            />
          </div>
          <div>
            ...
            <div className="relative">
              <input
                ...
                className="w-full rounded-xl border border-slate-300 px-4 py-3.5 pr-12 text-base focus:border-brand-500 focus:ring-2 focus:ring-brand-500 outline-none"
                required
              />
              <button
                type="button"
